...
if __name__ == '__main__':
    ...
    for i in range(5, 51, 5):
        ...
        parser.add_argument('--rank', type=int, default=i, help='the Rank of CPAC-Attention')
        parser.add_argument('--decomp', type=bool, default=True, help='use decomposed attention or not')
